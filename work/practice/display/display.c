...
void diplayScreen(int bus, char *value) {
	...
	writeI2cReg(bus, REG_OUTB, leftTop);
	writeI2cReg(bus, REG_OUTA, leftBottom);
	...
	writeI2cReg(bus, REG_OUTB, rightTop);
	writeI2cReg(bus, REG_OUTA, rightBottom);
